...
Static website for a local mechanic in Gulfport, Mississippi, built from the provided flyer style and service list.
...
- `assets/` - generated hero, CTA, logo, flyer reference, and service images
...
- Gallery images: replace files in `assets/services/` or update the gallery `<img>` paths in `index.html`
...
- CTA: dark garage banner with tools, sparks, tire tread texture, red/blue lighting, no text
